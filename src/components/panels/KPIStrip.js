...
const KPIStrip = ({ data, selectedActivity, activeGroup }) => {
  ...
  const { totalCredits, creditsByRegistry, creditsByCountry, allActivities, creditsByGroup, creditsByActivity, filteredCountry, filteredAgg } = data;
  ...
  const displayCredits = activeGroup
  ...
  const displayCountryCount = activeGroup
    ? (() => {
        const s = new Set();
